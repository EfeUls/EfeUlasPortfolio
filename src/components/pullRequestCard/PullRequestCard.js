    ...
    render() {
        ...
        if (pullRequest["mergedBy"] !== null) {
            ...
            mergedBy = ( <
                ...
                <
                a href = { pullRequest["mergedBy"]["url"] }
                target = "_blank"
                rel = "noopener noreferrer" >
                <
                img className = "merge-by-img"
        ...
        return ( <
            ...
            <
            span className = "iconify pr-icons"
            dataIcon = { iconPR.iconifyClass }
            style = { iconPR.style }
            dataInline = "false" >
            <
            /span> <
            ...
            target = "_blank"
            rel = "noopener noreferrer" > { pullRequest["title"] } <
            /a> < /
            p > <
            ...
            <
            p className = "files-changed-text"
            style = {
            ...
            href = { pullRequest["baseRepository"]["url"] } > { pullRequest["baseRepository"]["owner"]["login"] }
            ...
            <
            a href = { pullRequest["baseRepository"]["owner"]["url"] }
            target = "_blank"
            rel = "noopener noreferrer" >
            <
